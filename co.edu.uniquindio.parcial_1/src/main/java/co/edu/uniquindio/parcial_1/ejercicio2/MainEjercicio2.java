package co.edu.uniquindio.parcial_1.ejercicio2;

import co.edu.uniquindio.parcial_1.model.Atraccion;
import co.edu.uniquindio.parcial_1.model.Visitante;
...
public class MainEjercicio2 {
    ...
    private static Atraccion crearAtraccion(String nombre, String horarioOperacion, String descripcion,
        ...
        Atraccion atraccion = new Atraccion(nombre, horarioOperacion, descripcion, rangoEdad, nivelPeligro,
                pesoMaximo);
        return atraccion;
    }

    private static Visitante crearVisitante(String nombres, String apellidos, String edad,
                                            String numeroIdentificacion, String tipoVisitante, String sexo,
                                            String peso) {
